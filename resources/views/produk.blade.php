...
<body>
    ...
    <main>
        ...
        <div class="album py-5 bg-light">
            <div class="container">
                <h2 class="fw mb-5 text-center">Produk Pilihan</h2>
                        ...
                        <div class="card shadow-sm">
                            <svg class="bd-placeholder-img card-img-top" width="100%" height="225"
                                ...
                                <rect width="100%" height="100%" fill="#55595c" /><text x="50%" y="50%"
                                    fill="#eceeef" dy=".3em">{{ $data1 -> title }}</text>
                            </svg>

                            <div class="card-body">
                                <p class="card-text">{{ $data3 -> body }}<</p>
                    ...
                    <div class="col">
                        <div class="card shadow-sm">
                            <svg class="bd-placeholder-img card-img-top" width="100%" height="225"
                                ...
                                <title>Placeholder</title>
                                <rect width="100%" height="100%" fill="#55595c" /><text x="50%" y="50%"
                                    fill="#eceeef" dy=".3em">{{ $data2 -> title }}</text>
                            </svg>
                    ...
                    <div class="col">
                        <div class="card shadow-sm">
                            <svg class="bd-placeholder-img card-img-top" width="100%" height="225"
                                ...
                                <title>Placeholder</title>
                                <rect width="100%" height="100%" fill="#55595c" /><text x="50%" y="50%"
                                    fill="#eceeef" dy=".3em">{{ $data3 -> title }}</text>
                            </svg>
